 ...
 */
final class Version20200422190754 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE profil DROP edit_files, DROP move_files');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE profil ADD edit_files TINYINT(1) NOT NULL, ADD move_files TINYINT(1) NOT NULL');

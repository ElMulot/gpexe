	...
	public function load(ObjectManager $manager)
	{
		for ($i=0; $i<2; $i++) {
			...
			$metadata
				...
				->setMandatory(($i === 1)?true:false)
				->setDefaultRawValue(($i === 1)?'Default text':'')
				->setProject($this->getReference(constant(ProjectFixtures::class . "::PROJECT_{$i}")));
			$manager->persist($metadata);
			...
			$metadata
				...
				->setMandatory(($i === 1)?true:false)
				->setDefaultRawValue(($i === 1)?'2000-01-10':'')
				->setProject($this->getReference(constant(ProjectFixtures::class . "::PROJECT_{$i}")));
			$manager->persist($metadata);
			...
			$metadata
				...
				->setMandatory(($i === 1)?true:false)
				->setDefaultRawValue(($i === 1)?'http://example.com/':'')
				->setProject($this->getReference(constant(ProjectFixtures::class . "::PROJECT_{$i}")));
			$manager->persist($metadata);
			...
			$metadata
				...
				->setMandatory(($i === 1)?true:false)
				->setDefaultRawValue(($i === 1)?'Item serie 12':'')
				->setProject($this->getReference(constant(ProjectFixtures::class . "::PROJECT_{$i}")));
			$manager->persist($metadata);
			...
			$metadata
				...
				->setType(MetadataTypeEnum::LIST)
				->setMandatory(($i === 1)?true:false)
				->setDefaultRawValue(($i === 1)?'Item document 12':'')
				->setProject($this->getReference(constant(ProjectFixtures::class . "::PROJECT_{$i}")));
			$manager->persist($metadata);
			...
			$metadata
				...
				->setType(MetadataTypeEnum::LIST)
				->setMandatory(($i === 1)?true:false)
				->setDefaultRawValue(($i === 1)?'Item version 12':'')
				->setProject($this->getReference(constant(ProjectFixtures::class . "::PROJECT_{$i}")));
			$manager->persist($metadata);

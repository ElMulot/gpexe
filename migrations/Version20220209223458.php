 ...
 */
final class Version20220209223458 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE company DROP status, CHANGE type type ENUM(\'main_contractor\', \'sub_contractor\', \'supplier\', \'checker\') DEFAULT \'supplier\' NOT NULL COMMENT \'(DC2Type:CompanyTypeEnum)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE company ADD status ENUM(\'main_contractor\', \'sub_contractor\', \'supplier\', \'checker\') DEFAULT \'supplier\' NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:CompanyTypeEnum)\', CHANGE name name VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE codename codename VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE type type SMALLINT NOT NULL');
